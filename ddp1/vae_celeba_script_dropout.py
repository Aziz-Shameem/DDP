...
if __name__ == '__main__' :
    ...
    parser.add_argument("--conv_dims", type=list, default=[128, 256], help="conv dims for the encoder/decoder")
    ...
    if args.aug :
        transform=v2.Compose([
            ...
            v2.RandomZoomOut(side_range=(1.,1.2)),
    ...
    model = VAE(args.image_size, 3, args.conv_dims, args.fc_dim, args.latent_dim).to(device)
    ...
    torch.save(model, args.savedir+'/model.pt')
    plt.plot(losslog)
